...
using FluentSoftware.Web.Models.Account;
using FluentSoftware.Authorization.Users;
using FluentSoftware.Controllers;
using FluentSoftware.Identity;
using FluentSoftware.Sessions;
using FluentSoftware.Web.Views.Shared.Components.TenantChange;
using Microsoft.AspNetCore.Identity;

namespace FluentSoftware.Web.Controllers
{
    public class AccountController : FluentSoftwareControllerBase
    {
