...
using FluentSoftware.EntityFrameworkCore.Seed;
...
namespace FluentSoftware.EntityFrameworkCore
{
    ...
    public class FluentSoftwareEntityFrameworkModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FluentSoftwareEntityFrameworkModule).GetAssembly());
        }
